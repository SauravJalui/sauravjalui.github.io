...
{{< hextra/hero-badge link="/resume" >}}<div class="live-dot"></div><span>Senior Product Manager - Platform</span>{{< /hextra/hero-badge >}}

<div class="hx:mt-6 hx:mb-6">{{< hextra/hero-headline >}}Hi, I'm <img src="/images/lotus.svg" alt="lotus" class="headline-lotus" />Saurav. <br /> I build. I break. I blog. {{< /hextra/hero-headline >}}</div>

<!-- Hi, I'm Saurav 🪷 I build, I break, I blog.
Hi, I'm Saurav 🪷 chief wreckage officer @ AP Guru.
Hi, I'm Saurav 🪷 I make things happen and things break.
Hi, I'm Saurav 🪷 I build EdTech and document the damage.
Hi, I'm Saurav 🪷 shipping things, sweeping up after.
Hi, I'm Saurav 🪷 professionally responsible for what breaks
Hi, I'm Saurav 🪷 I build things and live to tell about it.
Hi, I'm Saurav 🪷 I ship first and explain later.
Hi, I'm Saurav 🪷 I build products and narrate the chaos.
Hi, I'm Saurav 🪷 I turn caffeine into products and posts.
Hi, I'm Saurav 🪷 I break production so you don't have to.
Hi, I'm Saurav 🪷 I build things and document the fallout.
Hi, I'm Saurav 🪷 I ship products and write up the scars.
Hi, I'm Saurav 🪷 I build in production and blog from the rubble.
Hi, I'm Saurav 🪷 I make things, break things, and take notes.
Hi, I'm Saurav 🪷 I ship, it breaks, I write about it.
Hi, I'm Saurav 🪷 I build products and blog the post-mortems.
Hi, I'm Saurav 🪷 I ship things and blog about what breaks.
Hi, I'm Saurav 🪷 building things, breaking things, writing it down.-->

<div class="hx:mb-12">{{< hextra/hero-subtitle >}}Developer-turned-product manager building EdTech at scale.&nbsp;<br class="hx:sm:block hx:hidden" />I write about product, platforms, and what breaks along the way.{{< /hextra/hero-subtitle >}}</div>

<div class="hx:mb-6">{{< hextra/hero-button text="Read the Blog" link="blog" >}}</div>
