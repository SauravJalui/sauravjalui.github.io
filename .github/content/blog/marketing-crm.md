...
Plenty of CRMs do pipelines and messaging better than anything I'd build in five sprints. HubSpot, Zoho, and LeadSquared are all more mature than what I've drawn, and buying one would have been faster. The honest case for buying is strong, and I want to state it properly rather than knock down a strawman.
...
I did it anyway, because of what it forces the funnel to measure. If "WhatsApp sent" is just an activity, the funnel tracks how prospects behave. If it's a stage, the funnel also tracks **how fast we respond**. A lead sitting in "captured" for two days becomes visibly our failure rather than an unremarkable row in a list. Most of our leakage, I suspect, isn't people saying no. It's people not being contacted while they still cared.
